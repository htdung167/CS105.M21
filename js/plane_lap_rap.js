...
export class Pilot {
  constructor() {
    ...
    this.armR.position.set(5, -10, 15);
    this.mesh.add(this.armR);
    this.armL = this.armR.clone();
    this.armL.position.set(5, -10, -15);
    ...
    this.hairs.position.set(-5, 15, 0);
    ...
    this.glassR.position.set(20, 0, 3);
    ...
    this.glassA.position.set(15, 0, 0);
...
export class Plane {
  constructor() {
    ...
    // this.tailPlane.position.set(-45, 40, 0);
    ...
    // this.sideWing.position.set(0, 30, 0);
    ...
    // blade1.position.x = blade2.position.x = 20;
    // blade2.castShadow = true;
    // blade2.receiveShadow = true;

    // this.propeller.add(blade1);
    // this.propeller.add(blade2);
    // this.propeller.position.set(120, 0, 0);
    ...
    // this.fireR.position.set(-10, 80, 60);
    ...
    // this.fireRv2.position.set(-10, 100, 60);
    ...
    this.pilot.mesh.position.set(0, 80, 0);
